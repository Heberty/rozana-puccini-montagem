	  	...
	  	<div class="row">
			<div class="col-xs-12">
			    ...
			    <div class="navbar-header">
			      ...
			      <a class="navbar-brand button-fixed" href="#header"><i class="fa fa-arrow-up"></i></a>
			    </div>
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li class=""><a href="sobre.php">Sobre <span class="sr-only">(current)</span></a></li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Produtos <span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="produtos.php#tab1">Papel</a></li>
								<li><a href="produtos.php#tab2">Cortinas</a></li>
								<li><a href="produtos.php#tab3">Almofadas</a></li>
